...
def predict_validation_set(model, batch_size=500, break_after_batches=None, folder='G:\AI\data\ILSVRC17\ILSVRC2012_img_val',
...
def get_path_from_id(img_id):
    ...
    return "{}/ILSVRC2012_val_000{}.JPEG".format('/home/z840/ALISURE/Data/VOC2012/ILSVRC2012_img_val/', img_id_str)
