...
def alexnet_model(weights_path=None):
    ...
    conv_2 = merge([
        ...
        (split_tensor(ratio_split=2, id_split=i)(conv_2)) for i in range(2)], # 前48个和后48个分别采用卷积的到128，然后merge256
        mode='concat', concat_axis=1, name="conv_2")
...
class AlexNet():
    ...
    def _sub_model(self):
        ...
        return Model(inputs=self.base_model.input, outputs=highest_layer.output)
